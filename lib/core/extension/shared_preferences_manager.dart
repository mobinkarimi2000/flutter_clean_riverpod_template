...
class SharedPreferencesManager {
  ...
  void setFirstDayOFWeek(int day) {
    _sharedPreferences.setInt(SharedPreferencesKeys.FirstDayOfWeek, day);
  }

  void clearFirstDayOFWeek() {
    _sharedPreferences.remove(SharedPreferencesKeys.FirstDayOfWeek);
  }

  int? getFirstDayOFWeek() {
    int? imageID =
        _sharedPreferences.getInt(SharedPreferencesKeys.FirstDayOfWeek);
    return imageID;
  }
}
